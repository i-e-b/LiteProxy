namespace LiteProxyTests
{
    ...
    public class DynamicDictionary : IDynamicMetaObjectProvider
    {
        ...
        private sealed class DynamicDictionaryMetaObject : DynamicMetaObject
        {
        ...
        public DynamicMetaObject Spit<T>(Expression<Func<T>> wha)
        {
            return new DynamicDictionaryMetaObject(wha, this);
        }
